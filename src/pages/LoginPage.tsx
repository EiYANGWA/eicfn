...
export default function LoginPage() {
  ...
  return (
    <main className="grid min-h-screen place-items-center overflow-hidden bg-[#18191a] px-4 py-8 text-zinc-100">
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_top,#1d4ed8_0,transparent_32%),radial-gradient(circle_at_bottom_left,#0f766e_0,transparent_28%)] opacity-30" />
